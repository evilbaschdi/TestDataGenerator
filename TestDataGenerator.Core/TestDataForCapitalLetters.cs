...
public class TestDataForCapitalLetters : ChainLinkValueFor<string, string>, ITestDataFor
{
    ...
    public TestDataForCapitalLetters(
    ...
    /// <inheritdoc />
    public override bool AmIResponsible => _testDataType.Value.Equals("Capital Letters");

    /// <inheritdoc />
    protected override string InnerValueFor(string input) => _generateTestData.ValueFor(_testDataCharPool.CapitalLetters);
}