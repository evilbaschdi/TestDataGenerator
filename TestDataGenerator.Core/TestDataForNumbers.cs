...
public class TestDataForNumbers : ChainLinkValueFor<string, string>, ITestDataFor
{
    ...
    /// <inheritdoc />
    public override bool AmIResponsible => _testDataType.Value.Equals("Numbers");

    /// <inheritdoc />
    protected override string InnerValueFor(string input) => _generateTestData.ValueFor(_testDataCharPool.Numbers);
}