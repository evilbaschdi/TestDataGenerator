...
/// <inheritdoc />
public class TestDataForNumbers : ChainHelperFor<string, string>
{
    ...
    public TestDataForNumbers(IChainHelperFor<string, string> chainHelperFor, IGenerateTestData generateTestData,
    ...
    /// <inheritdoc />
    public override bool AmIResponsible => Input.Equals("Numbers");

    /// <inheritdoc />
    protected override string InnerValueFor(string input)
    {
        return _generateTestData.ValueFor(_testDataCharPool.Numbers);
    }
}